...
arr.forEach(element => {
    element.addEventListener('click', (e) => {
        ...
        var link_href = document.querySelector(linkValue).scrollIntoView({
            behavior: 'smooth'
        });
        //close navMenu when anchor link is clicked
        if(navMenu.classList.contains("slide")) navMenu.classList.remove("slide");
    });
});
...
function slideIn(e) {
    ...
    } else if(e.target.id == "closeBtn" || e.target.closest("#closeBtn > span")){
